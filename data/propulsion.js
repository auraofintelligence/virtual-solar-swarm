...
window.VSS_ENGINES = [
  ...
  { id: "neumann", name: "Neumann Drive", fuel: "solid molybdenum rod", ispS: 9000,
    ...
    status: "Adelaide-built. Laboratory fuel mileage among the highest ever measured for its class; small units have flown in low Earth orbit. Deep-space scale is the open question.",
  ...
  { id: "nep", name: "Fission-electric (uranium)", fuel: "uranium reactor driving ion thrusters", ispS: 4000,
    ...
    status: "Kilopower-class space reactors are ground-proven; marrying one to big thrusters is engineering work, not new physics. Thorium versions live on paper only, so the reactors here are uranium.",
